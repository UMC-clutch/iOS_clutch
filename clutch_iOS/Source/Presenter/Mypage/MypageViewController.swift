...
class MypageViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    lazy var infoLabel: UILabel = {
        ...
        label.numberOfLines = 1
        let fontDescriptor = UIFontDescriptor(name: "AppleSDGothicNeo", size: 14)
...
//        return size
    ...
    //        case 0:
    //            present(NotifyPage, animated: true) // "전세사기 피해 신고 내역" 페이지로 이동
    //        case 1:
    //            present(CalculatePage, animated: true) // "전세사기 가능성 계산 내역"
    //        default :
    //            return
    //        }
    //    }
